#!/usr/bin/env python3
"""Analyze the final consolidated dataset."""
...
def main():
    final_file = 'datasets/ground_truth_combined_expanded/labeled_articles_cleaned.jsonl'

    print(f"Analyzing final consolidated dataset: {final_file}")
    print("=" * 80)
    ...
    print(f"\nTotal articles in final dataset: {len(articles):,}\n")
    ...
    print("TOP 20 SOURCES IN FINAL DATASET:")
    print("-" * 80)
    ...
    print("\n" + "=" * 80)
    print("COMPARISON TO CHECKPOINT (1000 articles):")
    print("-" * 80)
    print(f"Checkpoint size:     1,000 articles")
    print(f"Final dataset size:  {len(articles):,} articles")
    print(f"Growth:              {len(articles) - 1000:,} articles ({(len(articles)/1000 - 1)*100:.1f}% increase)")
