...
- **Passed Pre-filter**: 97 (97.0%)
- **Blocked by Pre-filter**: 3 (3.0%)

**Block Reasons**:

- corporate_finance: 2 (66.7%)
- military_security: 1 (33.3%)

**Cost Savings**: Pre-filter blocked 3 articles, saving expensive LLM API calls.
For ground truth generation (5,000 articles), this would save ~150 API calls.
