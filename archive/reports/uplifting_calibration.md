...
- **Passed Pre-filter**: 92 (92.0%)
- **Blocked by Pre-filter**: 8 (8.0%)

**Block Reasons**:

- corporate_finance: 6 (75.0%)
- military_security: 2 (25.0%)

**Cost Savings**: Pre-filter blocked 8 articles, saving expensive LLM API calls.
For ground truth generation (5,000 articles), this would save ~400 API calls.
