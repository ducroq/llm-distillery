"""
Investment Risk Pre-filter v4.0
...
class InvestmentRiskPreFilterV4:
...
def test_prefilter():
    ...
    prefilter = InvestmentRiskPreFilterV4()
    ...
    print(f"\nTesting Investment Risk Pre-filter v{InvestmentRiskPreFilterV4.VERSION}\n")
    print("=" * 80)
