"""
Investment Risk Filter v5 - Base Scorer Class
...
class BaseInvestmentRiskScorer(ABC):
    ...
    def _assign_signal_tier(
        ...
        Signal Tiers:
            - RED: Systemic risk unfolding - act now
            - YELLOW: Elevated risk - monitor closely
            - GREEN: Counter-cyclical opportunity
            - BLUE: Educational content - no action needed
