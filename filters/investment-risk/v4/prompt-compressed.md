...
**CALIBRATION GUIDANCE** (v4.0):
- **USE THE FULL 0-10 SCALE**: Don't cluster scores in the 1-3 range. Real market risk varies widely - score accordingly.
- **Score 7-10 for genuine risks**: 2008 financial crisis = 9-10 macro risk, COVID crash = 8-9, high inflation = 6-7
- **Score 7-10 for sentiment extremes**: VIX >30 = 7+, market panic = 8-9, euphoria (dotcom bubble) = 9-10
- **Evidence from financial journalism is valid**: WSJ, Bloomberg, FT analysis is 6-8 evidence quality (not just academic papers)
...
1. **Macro Risk Severity**: Systemic economic/financial risk?
   ...
   **EXAMPLES OF HIGH SCORES (7-10)**:
   - **9-10**: 2008 financial crisis (bank failures, credit freeze), COVID crash (March 2020), sovereign debt crisis
   - **7-8**: Russia-Ukraine energy crisis (2022), inflation shock (2021-2023), China property crisis
   - **6-7**: Fed tightening cycle concerns, yield curve inversion + rising unemployment, geopolitical tensions affecting energy/food
...
2. **Credit Market Stress**: Credit market deterioration?
   ...
   **EXAMPLES OF HIGH SCORES (7-10)**:
   - **9-10**: 2008 Lehman collapse, 2023 Silicon Valley Bank / Credit Suisse crisis, European sovereign debt crisis
   - **7-8**: High-yield spreads widening >500bp, regional bank stress, commercial real estate debt concerns
   - **6-7**: Corporate credit downgrades accelerating, junk bond yields rising, refinancing risks emerging
...
3. **Market Sentiment Extremes**: Dangerous extremes?
   ...
   **EXAMPLES OF HIGH SCORES (7-10)**:
   - **9-10**: March 2020 panic (VIX >80), 2008 Lehman panic, dotcom euphoria (1999-2000), crypto mania (2021)
   - **7-8**: VIX >30, extreme put/call ratios, widespread fear or greed indicators, "everyone is buying/selling"
   - **6-7**: VIX 25-30, elevated positioning, signs of FOMO or excessive caution
...
7. **Evidence Quality** (GATEKEEPER for RED: must be ≥5):
   ...
   **If NONE of above filters match, score normally:**
   - 0-2: Poor (unsubstantiated claims, pure opinion) | 3-4: Weak (some data but limited) | 5-6: Moderate (decent analysis, some hard data) | 7-8: Strong (good analysis, hard data, expert sources) | 9-10: Exceptional (official stats, central bank reports, academic rigor)
   - Hard data vs opinion, official stats vs blogs, sound reasoning, track record

   **EXAMPLES OF ACCEPTABLE EVIDENCE (5-8)**:
   - **7-8**: WSJ/Bloomberg/FT analysis with data, central bank speeches, official economic reports, IMF/World Bank analysis
   - **5-6**: Reputable financial journalism with some data, market commentary from established sources, historical comparisons
   - **3-4**: Opinion pieces with limited data, blog posts from unknown sources, speculation without evidence
