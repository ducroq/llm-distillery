"""
Uplifting Content Filter v7 - HuggingFace Hub Inference
...
Usage:
    from filters.uplifting.v7.inference_hub import UpliftingScorerHub

    scorer = UpliftingScorerHub(
        repo_id="jeergrvgreg/uplifting-filter-v7",
...
class UpliftingScorerHub(BaseUpliftingScorer):
    ...
    def __init__(
        self,
        repo_id: str = "jeergrvgreg/uplifting-filter-v7",
