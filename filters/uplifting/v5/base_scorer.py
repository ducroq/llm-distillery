"""
Uplifting Content Filter v5 - Base Scorer Class

Shared logic for UpliftingScorer and UpliftingScorerHub.
...
class BaseUpliftingScorer(ABC):
    """
    Abstract base class for uplifting content scoring.

    Provides shared logic for both local model loading (UpliftingScorer)
    and HuggingFace Hub loading (UpliftingScorerHub).
    ...
    EVIDENCE_DIMENSION = "evidence_level"
