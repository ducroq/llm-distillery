"""
Uplifting Content Filter v5 - HuggingFace Hub Inference
...
class UpliftingScorerHub:
    ...
    def __init__(
        self,
        repo_id: str = "jeergrvgreg/uplifting-filter-v5",
    ...
    def score_article(
        ...
        # Gatekeeper: Evidence < 3 caps at 3.0
