"""
Nature Recovery Filter v1 - Hybrid Inference Pipeline
...
Usage:
    from filters.nature_recovery.v1.inference_hybrid import NatureRecoveryHybridScorer
    ...
    # CLI
    python filters/nature_recovery/v1/inference_hybrid.py --input articles.jsonl --output results.jsonl
"""
...
from filters.nature_recovery.v1.inference import NatureRecoveryScorer
