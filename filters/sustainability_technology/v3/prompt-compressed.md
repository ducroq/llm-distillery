...
## ⛔ CRITICAL SCOPE EXCLUSIONS (Score ALL dimensions 0.0)

**IMPORTANT:** If the article falls into ANY of these categories, score ALL six dimensions as **0.0** with evidence "Out of scope: [category]". These are NOT sustainability technologies regardless of any keywords present:

### 1. AI/ML Infrastructure (without sustainability application)
- Model architectures, training techniques, benchmarks (transformers, attention, SOTA results)
- LLM/language model releases, fine-tuning methods, inference optimization
- Computer vision research (image classification, object detection, segmentation)
- General ML frameworks, tools, libraries, APIs
- **Exception:** AI/ML explicitly applied to sustainability (grid optimization, climate modeling, energy forecasting) WITH quantified environmental impact

### 2. Consumer Electronics
- Smartphone/tablet reviews, comparisons, pricing guides (iPhone, Galaxy, Pixel, Xiaomi, Oppo, Vivo, etc.)
- Gaming hardware, GPUs, gaming laptops, consoles (unless energy efficiency is the primary focus)
- Wearables, headphones, smart home gadgets without sustainability metrics
- PC hardware shopping guides, build recommendations

### 3. Programming & Software Development
- Developer tutorials, coding guides, API documentation
- Software framework releases, library updates
- GitHub trending repos (unless explicitly sustainability-focused)
- Reddit programming discussions, developer tools, workflow tips

### 4. Other Off-Topic Categories
- Military technology, defense systems, weapons, submarines
- Travel/tourism content, flight deals, vacation planning
- Cryptocurrency speculation (unless analyzing proof-of-stake energy efficiency)
- Healthcare/medical research without environmental health connection
- Entertainment, gaming news, esports
- Lifestyle articles, life hacks, cooking recipes

### Out-of-Scope Examples (ALL dimensions = 0.0)
| Article Title | Category | Why Out of Scope |
|--------------|----------|------------------|
| "New transformer architecture achieves SOTA on ImageNet" | AI/ML infrastructure | No sustainability application |
| "Samsung Galaxy S26 review: faster charging, better camera" | Consumer electronics | Product review, not sustainability tech |
| "FlashAttention 3.0 speeds up LLM inference by 50%" | AI/ML infrastructure | Optimization technique, no sustainability |
| "Building REST APIs with FastAPI: Complete Guide" | Programming | Developer tutorial |
| "I benchmarked 7 Small LLMs on a 16GB Laptop" | AI/ML infrastructure | Hardware benchmark, no sustainability |
| "Japan unveils new stealth submarine technology" | Military | Defense technology |
| "Best travel apps for your World Cup trip" | Travel | Tourism content |
| "Minimax M2.1 released - new open source LLM" | AI/ML infrastructure | Model release, no sustainability |
