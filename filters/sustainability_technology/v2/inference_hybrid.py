"""
Sustainability Technology Filter v2 - Hybrid Inference Pipeline
...
Usage:
    from filters.sustainability_technology.v2.inference_hybrid import SustainabilityTechnologyHybridScorer
    ...
    # CLI
    python filters/sustainability_technology/v2/inference_hybrid.py --input articles.jsonl --output results.jsonl
"""
...
from filters.sustainability_technology.v2.inference import SustainabilityTechnologyScorer
...
class SustainabilityTechnologyHybridScorer(HybridScorer):
    """
    Two-stage hybrid scorer for sustainability_technology filter v2.

    Combines:
    - Stage 1: multilingual-e5-small embeddings + MLP probe
    - Stage 2: Existing SustainabilityTechnologyScorer (Qwen2.5-1.5B fine-tuned)
    """
    ...
    def _get_embedding_stage_config(self) -> Dict:
        """Return EmbeddingStage configuration for sustainability_technology v2."""
        return {
