"""
Cultural Discovery Filter v5 - Hybrid Inference Pipeline
...
Usage:
    from filters.cultural_discovery.v5.inference_hybrid import CulturalDiscoveryHybridScorer
    scorer = CulturalDiscoveryHybridScorer()
    result = scorer.score_article(article)
    # result["stage_used"] -> "stage1_low" or "stage2"

    # CLI
    python filters/cultural_discovery/v5/inference_hybrid.py --input articles.jsonl --output results.jsonl
"""
...
class CulturalDiscoveryHybridScorer(HybridScorer):
    ...
    def __init__(
        ...
        self._scorer_module = import_module("filters.cultural_discovery.v5.inference")
